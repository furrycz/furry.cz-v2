CREATE TABLE `Contacts` (
  ...
  KEY `UserId` (`UserId`),
  KEY `TypeId` (`TypeId`),
  CONSTRAINT `Contacts_ibfk_4` FOREIGN KEY (`TypeId`) REFERENCES `ContactTypes` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Contacts_ibfk_3` FOREIGN KEY (`UserId`) REFERENCES `Users` (`Id`) ON DELETE NO ACTION ON UPDATE NO ACTION
